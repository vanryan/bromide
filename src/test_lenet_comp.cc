...
int perf_lenet_comp(Halide::ImageParam input_data, Halide::ImageParam labels, int count=1) {

	NetParameter param;

	ReadNetParamsFromBinaryFile("/home/rding/Bromide/bromide/resources/lenet_iter_10000.caffemodel", &param);
	/*
	//show param
...
void test_lenet_comp() {
	...
	for (int l = 0; l < count; l++) {
  	...
  	Halide::Image<float> test_correct = perf_lenet_comp(input_data, input_labels, count);
}