...
int perf_alexnet_comp(Halide::ImageParam input_data, Halide::ImageParam labels, int count=1) {

	NetParameter param;
  	ReadNetParamsFromBinaryFile("/home/rding/Bromide/bromide/resources/bvlc_alexnet.caffemodel", &param);
...
void test_alexnet_comp() {

	std::vector<std::string> input_images;
	input_images.push_back("/home/rding/Bromide/bromide/resources/cat.ppm");

	std::string mean_proto = "/home/rding/Bromide/bromide/resources/imagenet_mean.binaryproto";
	BlobProto mean_blob;
	...
	for (int l = 0; l < count; l++) {
  	...
  	Halide::Image<float> test_correct = perf_alexnet_comp(input_data, input_labels, count);
}